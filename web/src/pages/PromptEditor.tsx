      ...
      <div className="flex items-center justify-between p-4 border-b border-slate-700">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            onClick={handleSave}
            disabled={saving}
            className="flex items-center gap-2 px-4 py-2 bg-sunset-500 hover:bg-sunset-600 rounded-lg transition-colors disabled:opacity-50"
          >
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                disabled={isEditing}
                className="w-full px-3 py-2 bg-slate-800 border border-slate-700 rounded-lg focus:border-sunset-500 focus:ring-1 focus:ring-sunset-500 outline-none disabled:opacity-50"
                placeholder="my-awesome-prompt"
              />
            </div>
            ...
            <div>
              ...
              <div className="relative">
                <select
                  ...
                  className="w-full px-3 py-2 bg-slate-800 border border-slate-700 rounded-lg focus:border-sunset-500 focus:ring-1 focus:ring-sunset-500 outline-none appearance-none"
                >
            ...
            <div>
              ...
              <textarea
                ...
                rows={3}
                className="w-full px-3 py-2 bg-slate-800 border border-slate-700 rounded-lg focus:border-sunset-500 focus:ring-1 focus:ring-sunset-500 outline-none resize-none"
